...
<div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
			...
			<li <?php if (isset($_GET['a']) && $_GET['a'] == 22) {echo 'class="active"';} ?>>
                <a href="index.php?a=22"><i class="glyphicon glyphicon-globe"></i> <?php echo $osmw_menu_top_4;?></a>
            </li>
			<li <?php if (isset($_GET['a']) && $_GET['a'] == 21) {echo 'class="active"';} ?>>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li <?php if (isset($_GET['a']) && $_GET['a'] == 13) {echo 'class="active"';} ?>>
